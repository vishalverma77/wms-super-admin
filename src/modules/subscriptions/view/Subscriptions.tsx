...
import type { SubscriberItem, EnterpriseContactItem } from "../types";

const subscribers: SubscriberItem[] = [
  {
    id: 1,
    company: "Bright Digital",
    email: "info@bright.digital",
    plan: "Pro",
    since: "2026-01-12",
    status: "Active",
    seats: 14,
...
const initialEnterpriseContacts: EnterpriseContactItem[] = [
  {
    id: 1,
    name: "Alice Cooper",
    ...
    company: "Globex Corp",
    requestDate: "Jul 20, 2026",
    status: "New",
  },
  {
    id: 2,
    name: "Bob Marley",
    email: "bob.m@starkind.com",
    phone: "+1 (555) 928-1122",
    company: "Stark Industries",
    requestDate: "Jul 21, 2026",
    status: "New",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    phone: "+1 (555) 776-5566",
    company: "Amazon",
    requestDate: "Jul 23, 2026",
    status: "New",
  },
];
...
export function Subscriptions() {
  ...
  const [contacts, setContacts] = useState<EnterpriseContactItem[]>(
    initialEnterpriseContacts,
  );
  ...
  const handleMarkAsContacted = (id: number) => {
    setContacts(
      contacts.map((c) =>
        c.id === id ? { ...c, status: "Contacted" as const } : c,
      ),
    );
  };
        ...
        <div className="ent-banner">
          <div className="ent-banner-content">
            ...
            <div>
              ...
              >
                You have {newContactsCount} new contact requests from the
                landing page.
              </p>
            </div>
          </div>
            ...
            <tbody>
              {subscribers.map((row) => (
                <tr key={row.id}>
                  ...
                  <td>
                    <span
                      className={`tag ${row.status === "Active" ? "t-green" : "t-orange"}`}
                    >
                      {row.status}
                    </span>
                  </td>
            ...
            <div className="ent-modal-header">
              <div style={{ minWidth: 0, flex: 1 }}>
                <h2
                  style={{
                    margin: 0,
                    fontSize: "clamp(16px, 3.5vw, 1.35rem)",
                ...
                >
                  List of leads that submitted the enterprise contact form from
                  the landing page.
                </p>
              </div>
              <button
